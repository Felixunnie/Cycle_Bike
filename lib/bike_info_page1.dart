...
class bike_info_page1 extends StatefulWidget {
  const bike_info_page1({super.key});

  @override
  State<bike_info_page1> createState() => _BikeInfoPage1State();
}

class _BikeInfoPage1State extends State<bike_info_page1> {
  @override
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(
                        'https://www.brooklynbicycleco.com/cdn/shop/files/Willow_7_2023_Profile.png?v=1678338874'
                          ),
                    ),
                  ),
                ),
