...
class bike_info_page3 extends StatefulWidget {
  const bike_info_page3({super.key});

  @override
  State<bike_info_page3> createState() => _BikeInfoPage3State();
}

class _BikeInfoPage3State extends State<bike_info_page3> {
  @override
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(
                        'https://freepngimg.com/thumb/bicycle/3-bicycle-png-image.png'
                          ),
                    ),
                  ),
                ),
