...
class bike_info_page2 extends StatefulWidget {
  const bike_info_page2({super.key});

  @override
  State<bike_info_page2> createState() => _BikeInfoPage2State();
}

class _BikeInfoPage2State extends State<bike_info_page2> {
  @override
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(
                        'https://freepngimg.com/thumb/bicycle/23483-6-bicycle-transparent-image.png'
                          ),
                    ),
                  ),
                ),
