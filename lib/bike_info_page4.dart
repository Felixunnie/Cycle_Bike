...
class bike_info_page4 extends StatefulWidget {
  const bike_info_page4({super.key});

  @override
  State<bike_info_page4> createState() => _BikeInfoPage4State();
}

class _BikeInfoPage4State extends State<bike_info_page4> {
  @override
