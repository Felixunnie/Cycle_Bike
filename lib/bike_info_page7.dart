...
class bike_info_page7 extends StatefulWidget {
  const bike_info_page7({super.key});

  @override
  State<bike_info_page7> createState() => _BikeInfoPage7State();
}

class _BikeInfoPage7State extends State<bike_info_page7> {
  @override
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(
                        'https://freepngimg.com/thumb/bicycle/7-bicycle-png-image.png'
                          ),
                    ),
                  ),
                ),
