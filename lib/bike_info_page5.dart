...
class bike_info_page5 extends StatefulWidget {
  const bike_info_page5({super.key});

  @override
  State<bike_info_page5> createState() => _BikeInfoPage5State();
}

class _BikeInfoPage5State extends State<bike_info_page5> {
  @override
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(
                        'https://freepngimg.com/thumb/bicycle/1-bicycle-png-image.png'
                          ),
                    ),
                  ),
                ),
